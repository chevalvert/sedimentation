...
Midi.register(Store.seed, { cc: 45, update: v => v > 0 ? Date.now() : Store.seed.get() })
Midi.register(Store.creature.scaleX, { cc: 16 })
Midi.register(Store.creature.scaleY, { cc: 17 })
Midi.register(Store.postprocessing.edgeWorkRadius, { cc: 19, update: v => 30 + v * 500 })
...
Midi.register(Store.scene.bgColor, { cc: 4, update: v => 135 + v * 360 })
//Midi.register(Store.scene.bgImage, { cc: 5, update: v => Math.floor(0 + v * 27) })
Midi.register(Store.scene.bgImage, { cc: 42, update: v => Prng.randomInt(0, 27) })
...
Tweakpane.register(Store.postprocessing.edgeWorkRadius, 'edgeWork Radius', { min: 30, max: 500})
...
Tweakpane.register(Store.scene.bgColor, 'Couleur fond', { min: 135, max: 360, step: 1 })
